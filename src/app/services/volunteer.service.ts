...
/*
  ...
  getAllVolunteersByIdTask(taskId: number) {
    return this.httpClient.get(`${this.API_URL}/get-all-volunteers-ordered-by-skills-by-task/${taskId}`)
  }

  findVolunteerByTask_Event_IdEvent(eventid: number) {
    return this.httpClient.get(`${this.API_URL}/retrievevolunteersbyevent/${eventid}`)
  }

  retrieveVolunteersByUser(userid: number) {
    return this.httpClient.get(`${this.API_URL}/retrieve-volunteer-by-user/${userid}`)
  }
  ...
  getVolunteer(idVolunteer : any){
    return this.httpClient.get(`${this.API_URL}/retrieve-volunteer/${idVolunteer}`)
  }
  ...
  addVolunteerByTask(volunteer: any, taskId: number,userId :number) {
    return this.httpClient.post(`${this.API_URL}/create-volunteer/${taskId}/${userId}`, volunteer);
  }



  deleteVolunteer(idVolunteer : any){
    return  this.httpClient.delete(`${this.API_URL}/remove-volunteer/${idVolunteer}`)
  }
  ...
  retrieveNumberVolunteersByIdTask(taskId: number): Observable<number> {
    return this.httpClient.get<number>(`${this.API_URL}/retrieve-number-volunteers/${taskId}`);
  }
